// ----------------------------------------
// ORIRIGNAL VERSION OF IMAGEVIEWTOUCH.JAVA
// ----------------------------------------
...
public class ImageViewTouch extends ImageViewTouchBase {
	...
	public void setImageRotateBitmapReset( RotateBitmap bitmap, boolean reset )
	{
		...
		mScaleFactor = getMaxZoom() / 4; // changed from "/ 3";
	}
...
// ----------------------------------------
// NEW VERSION OF IMAGEVIEWTOUCH.JAVA WITHOUT SCALEGESTUREDETECTOR
// ----------------------------------------
//package tynstep.android.viewer.imagezoom;
//
//import android.content.Context;
...
//		{
//			if ( e1 == null || e2 == null ) return false;
//			if (touchState != DRAG) return false;
//			if ( getScale() == 1f ) return false;
//			scrollBy( -distanceX, -distanceY );
//			invalidate();
//			return super.onScroll( e1, e2, distanceX, distanceY );
