...
public class StorageOptions {
	...
	public static void determineStorageOptions() {
		readMountsFile();
        readVoldFile();
//        compareMountsWithVold();  // N.B. on test device this was found to remove external sd mount as it is not present in vold file
...
//  		File mounts2 = new File("/etc/vold.conf");
//  		File mounts3 = new File("/etc/vold.fstab");
//  		Log.d("stor1","" + mounts.exists());
//  		Log.d("stor2",""+mounts2.exists());
//  		Log.d("stor3",""+mounts3.exists());
	...
	private static void setProperties() {
	    ...
	    if (mMounts.size() > 0) {
	    	...
	    	mLabels.add("Auto"); // Using Android 2.2 (Froyo)
